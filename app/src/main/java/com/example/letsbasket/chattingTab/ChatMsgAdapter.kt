...
class ChatMsgAdapter(private val context: Context): RecyclerView.Adapter<ChatMsgAdapter.ViewHolder>() {

    var datas = mutableListOf<ChatMsgItem>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChatMsgAdapter.ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.custom_chat_msg, parent, false)
    ...
    override fun onBindViewHolder(holder: ChatMsgAdapter.ViewHolder, position: Int) {
